...
class DefaultSuggestionsFinderTest {
    ...
    private void initSuggestions() {
        ...
        TargetEntity targetEntity1 = new TargetEntity(
            "key_1", "diagnosis", TargetEntityType.RULE, new TargetEntityDataFields(), null, null);
        ...
        TargetEntity targetEntity2 = new TargetEntity(
            "key_2", "diagnosis", TargetEntityType.RULE, new TargetEntityDataFields(), null, null);
        ...
        TargetEntity targetEntity3 = new TargetEntity(
            "key_3", "diagnosis", TargetEntityType.ONTOLOGY, new TargetEntityDataFields(), null, null);
        ...
        TargetEntity targetEntity4 = new TargetEntity(
            "key_4", "diagnosis", TargetEntityType.ONTOLOGY, new TargetEntityDataFields(), null, null);
